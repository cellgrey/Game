...
int main()
{
    ...
    printf("4: Barman (NEW)\n");
    Beep(523, 600);Sleep(200);Beep(470, 500);Sleep(200);Beep(523, 500);Beep(523, 500);Beep(523, 300);Beep(470, 500);Sleep(200);
    scanf("%d", &choose);
    switch(choose)
    {
        case 1: Beep(500, 500);start(money);
        case 2: Beep(300, 500);help();
        case 3: Beep(300, 300);quit();
        case 4: Beep(300, 300);barman(barmanmoney);
