...

{
    ...
    printf("3: Delete Savegame\n");
    printf("4: What the Hell i am doin?\n");
    printf("5: Leave me alone i QUIT!\n");
    scanf("%d", &choose);
    switch(choose)
    {
        case 1: start(money);
        case 2: barman(barmanmoney);
        case 3: deletesave(money);
        case 4: help();
        case 5: quit();
        default: printf("Choose a number from 1, 2, 3, 4 or 5!\n");system("pause");main();
    }
}

int deletesave(money)
{
    FILE *fp;
